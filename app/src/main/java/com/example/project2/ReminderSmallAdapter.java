...
public class ReminderSmallAdapter extends RecyclerView.Adapter<ReminderViewHolder> {
    Context context;
    List<Reminder> reminders;

    public ReminderSmallAdapter(Context context, List<Reminder> reminders) {
    ...
    public ReminderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ReminderViewHolder(LayoutInflater.from(context).inflate(R.layout.reminder_card_small_design, parent, false));
    }
...
//            @Override
//            public void onClick(View view) { //implement delete reminder
